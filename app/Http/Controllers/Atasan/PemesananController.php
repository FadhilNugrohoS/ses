...
class PemesananController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Super-Admin.Pemesanan-Page.Pemesanan',compact('pesanans'));
    }
    ...
    public function create()
    {
        ...
        return view('Super-Admin.Pemesanan-Page.create',compact('barangs'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('Super-Admin.Pemesanan-Page.edit',compact('pesanans','barangs'));
    }
    ...
    public function proses($id)
    {
        ...
        if($pesanans){
            ...
            Alert::error('Pesanan Gagal Teverifikasi','Error');
            return redirect()->route('pemesanans.index');
        }
